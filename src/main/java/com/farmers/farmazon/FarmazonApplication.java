...
public class FarmazonApplication {
	...
	CommandLineRunner commandLineRunner (UserRepo userRepo, CartRepo cartRepo, ProductLineRepo productLineRepo, ProductRepo productRepo) {
		...
		return args -> {
			...
			jack.setUsername("erg");
			jack.setPassword("erg");
